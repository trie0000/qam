// Feather 風アイコン（stroke 1.7 / 24 viewBox / currentColor）。絵文字は使わない。
// width/height を明示（flex 内で 0px に潰れない・UIルール §5.3）。
const INNER: Record<string, string> = {
  ...
  // 取り込み: 受信トレイ（データが入ってくる）。Export(上矢印)/Download(下矢印)と区別する。
